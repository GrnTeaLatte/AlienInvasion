...
class Raindrop(Sprite):
    ...
    def update(self):
        """ Move raindrop to the right or left"""
        self.x += (self.ai_settings.raindrop_speed_factor * self.ai_settings.fleet_direction)
        self.y += (self.ai_settings.raindrop_speed_factor * self.ai_settings.fleet_direction)
        self.rect.y = self.y
