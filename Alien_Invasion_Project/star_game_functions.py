...
def update_screen(ai_settings, screen, star):
...
def create_star(ai_settings, screen, stars, star_number, row_number):
    ...
    star.x = star_width + randint(0, 10) * star_width * star_number
    star.rect.x = star.x
    star.rect.y = star.rect.height + randint(0, 10) * star.rect.height * row_number
    stars.add(star)
